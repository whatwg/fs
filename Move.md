...
Access Handle, then moved to a directory of the user's choice. However, writes
...
`move(new_entry_name)` is guaranteed to fall under this case.
...
Cons:
- We should allow for efficient moves across directories and across file
  systems, including out of the Origin Private File System.
